package com.example.task9_1p.adapter;
...
//
            ...
            while (iterator.hasNext()) {
                ...
                CharacterStyle boldStyle = new StyleSpan(Typeface.BOLD);
                CharSequence fullText = prediction.getFullText(boldStyle);
